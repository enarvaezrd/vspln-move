...
void RRTA::Trajectory_Prediction(geometry_msgs::Pose Marker_Abs_Pose)
{
...
struct MeanValues RRTA::XYMean_Calculation(geometry_msgs::Pose Marker_Abs_Pose)
{
    tic();
...
void RRTA::Regression(std::vector<double> x,std::vector<double> y,int ndatos,int it,int order, std::vector<double> &coeffs)
{
    //x-Valores de X
    //y-Valores de Y
...
void RRTA::CheckandFix_Boundaries(std::vector<double>  &x, std::vector<double>  &y, int &prof_e)
{
...
void RRTA::RRT_SequenceA(geometry_msgs::Pose Marker_Abs_Pose)//extraer vecindad
{
    finish=false;
    tic();
...
//================================== For SImulator =======================================================
bool RRTA::Check_CollisionA(std::vector<double> posit, int i)
{
...
long double RRTA::toc(double tic_clock) 
{
