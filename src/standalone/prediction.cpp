...
void Prediction::CreateMap()
{
    ...
    for (int x = 0; x < MapSize; x++)
    {
        ...
        {
            ObstacleMap[x][y]=0;
            //cout<<h<<": "<<ObstacleMap[w][h]<<", ";
           // if (x>1900 && x<2100 && y>3450 && y<3580)// down
           //if (x>3400 && x<3600 && y>1900 && y<2100)// right
